        ...
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
            <div className="max-w-md mx-auto">
                ...
                <div className="divide-y divide-gray-200">
                    <form onSubmit={handleLogin} className="py-8 text-basse leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                      ...
                      {error ? <p className='text-red-600 text-base'>Email or Password is not Correct</p>:""}
                        <p>if you don't have an account?<Link to="/sign-up" className='text-blue-600 underline'>Sign Up</Link> </p>
                        <div className="relative">
                ...
                <div className='flex w-full items-center flex-col mt-5 gap-3'>
                    <button className='block' onClick={handleRegister}>
                        <img src={googleLogo} alt="logo" className='w-12 h-12 inline-block'/>Login with Google
                    </button>
                </div>
            </div>
        </div>
